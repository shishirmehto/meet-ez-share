/* listeners which listens to the events triggered from the frontend. */
...
/**
 * It creates a meeting and stores the meeting ID and the email of the creator in the chrome storage
 */
function createMeeting() {
  chrome.identity.getAuthToken({ interactive: true }, function (token) {
    ...
    let event = {
      ...
      description: 'Lets do a quick google meetup.',
      start: {
